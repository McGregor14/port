...
Primary analyses use fear conditioning variables to predict last session GAD-7 scores while controlling for first session GAD-7 score and number of treatment sessions completed.
